...
router.get("/:seriesId/episodes", async (req, res) => {
  try {
    ...
    res.status(200).json({
      ...
      seriesSeasonNumber: series.seasonNumber,
      seriesGenres: series.genres,
      seriesActors: series.actors,
      seriesDirectors: series.directors,
      seriesWriters: series.writers,
      seriesImdbRating: series.imdbRating,
      seriesCountries: series.countries,
      seriesRuntime: series.runtime,
      seriesFreePaid: series.freePaid,
      seriesTrailerUrl: series.trailerUrl,
      seriesVideoQuality: series.videoQuality,
